...
# This section contains the code for sidebar controls to filter data
...
# Main section 1: Average Stuff+ Leaderboard
...
# Section 2: Top Individual Pitches Tracked
...
# 4. Format numbers to make display look nice
